...
{id:50,name:"Fire Breath+",mods:[0,8,0,0,0]},
{id:51,name:"Flametongue",mods:[0,11,0,0,0]},
{id:52,name:"Flametongue+",mods:[0,15,0,0,0]},
{id:53,name:"Flux",mods:[0,4,0,0,0]},
{id:54,name:"Fólkvangr",mods:[0,16,0,0,0]},
{id:55,name:"FujinYumi",mods:[0,14,0,0,0]},
{id:56,name:"Gravity",mods:[0,6,0,0,0]},
{id:57,name:"Gronnblade",mods:[0,9,0,0,0]},
{id:58,name:"Gronnblade+",mods:[0,13,0,0,0]},
{id:59,name:"Gronnraven",mods:[0,7,0,0,0]},
{id:60,name:"Gronnraven+",mods:[0,11,0,0,0]},
{id:61,name:"Gronnwolf",mods:[0,6,0,0,0]},
{id:62,name:"Gronnwolf+",mods:[0,10,0,0,0]},
{id:63,name:"Hammer",mods:[0,8,0,0,0]},
{id:64,name:"Hammer+",mods:[0,12,0,0,0]},
{id:65,name:"Hauteclere",mods:[0,16,0,0,0]},
{id:66,name:"Heavy Spear",mods:[0,8,0,0,0]},
{id:67,name:"Heavy Spear+",mods:[0,12,0,0,0]},
{id:68,name:"Iron Axe",mods:[0,6,0,0,0]},
{id:69,name:"Iron Bow",mods:[0,4,0,0,0]},
{id:70,name:"Iron Dagger",mods:[0,3,0,0,0]},
{id:71,name:"Iron Lance",mods:[0,6,0,0,0]},
{id:72,name:"Iron Sword",mods:[0,6,0,0,0]},
{id:73,name:"Killer Axe",mods:[0,7,0,0,0]},
{id:74,name:"Killer Axe+",mods:[0,11,0,0,0]},
{id:75,name:"Killer Bow",mods:[0,5,0,0,0]},
{id:76,name:"Killer Bow+",mods:[0,9,0,0,0]},
{id:77,name:"Killer Lance",mods:[0,7,0,0,0]},
{id:78,name:"Killer Lance+",mods:[0,11,0,0,0]},
{id:79,name:"Killing Edge",mods:[0,7,0,0,0]},
{id:80,name:"Killing Edge+",mods:[0,11,0,0,0]},
{id:81,name:"Light Breath",mods:[0,9,0,0,0]},
{id:82,name:"Light Breath",mods:[0,9,0,0,0]},
{id:83,name:"Light Breath+",mods:[0,13,0,0,0]},
{id:84,name:"Light Breath+",mods:[0,13,0,0,0]},
{id:85,name:"Lightning Breath",mods:[0,7,0,0,0]},
{id:86,name:"Lightning Breath",mods:[0,7,0,0,0]},
{id:87,name:"Lightning Breath+",mods:[0,11,0,0,0]},
{id:88,name:"Lightning Breath+",mods:[0,11,0,0,0]},
{id:89,name:"Mystletainn",mods:[0,16,0,0,0]},
{id:90,name:"Naga",mods:[0,14,0,0,0]},
{id:91,name:"Nóatún",mods:[0,16,0,0,0]},
{id:92,name:"Pain",mods:[0,3,0,0,0]},
{id:93,name:"Panic",mods:[0,7,0,0,0]},
{id:94,name:"Parthia",mods:[0,14,0,0,0]},
{id:95,name:"Poison Dagger",mods:[0,2,0,0,0]},
{id:96,name:"Poison Dagger+",mods:[0,5,0,0,0]},
...
{id:104,name:"Rexcalibur",mods:[0,9,0,0,0]},
{id:105,name:"Rogue Dagger",mods:[0,4,0,0,0]},
{id:106,name:"Rogue Dagger+",mods:[0,7,0,0,0]},
{id:107,name:"Ruby Sword",mods:[0,8,0,0,0]},
{id:108,name:"Ruby Sword+",mods:[0,12,0,0,0]},
{id:109,name:"Ruin",mods:[0,6,0,0,0]},
{id:110,name:"Sapphire Lance",mods:[0,8,0,0,0]},
{id:111,name:"Sapphire Lance+",mods:[0,12,0,0,0]},
{id:112,name:"Sieglinde",mods:[0,16,0,0,0]},
{id:113,name:"Siegmund",mods:[0,16,0,0,0]},
{id:114,name:"Silver Axe",mods:[0,11,0,0,0]},
{id:115,name:"Silver Axe+",mods:[0,15,0,0,0]},
{id:116,name:"Silver Bow",mods:[0,9,0,0,0]},
{id:117,name:"Silver Bow+",mods:[0,13,0,0,0]},
{id:118,name:"Silver Dagger",mods:[0,7,0,0,0]},
{id:119,name:"Silver Dagger+",mods:[0,10,0,0,0]},
{id:120,name:"Silver Lance",mods:[0,11,0,0,0]},
{id:121,name:"Silver Lance+",mods:[0,15,0,0,0]},
{id:122,name:"Silver Sword",mods:[0,11,0,0,0]},
{id:123,name:"Silver Sword+",mods:[0,15,0,0,0]},
{id:124,name:"Slow",mods:[0,5,0,0,0]},
{id:125,name:"Smoke Dagger",mods:[0,6,0,0,0]},
{id:126,name:"Smoke Dagger+",mods:[0,9,0,0,0]},
{id:127,name:"Sol Katti",mods:[0,16,0,0,0]},
{id:128,name:"Steel Axe",mods:[0,8,0,0,0]},
{id:129,name:"Steel Bow",mods:[0,6,0,0,0]},
{id:130,name:"Steel Dagger",mods:[0,5,0,0,0]},
{id:131,name:"Steel Lance",mods:[0,8,0,0,0]},
{id:132,name:"Steel Sword",mods:[0,8,0,0,0]},
{id:133,name:"Thoron",mods:[0,9,0,0,0]},
{id:134,name:"Thunder",mods:[0,4,0,0,0]},
{id:135,name:"Tyrfing",mods:[0,16,0,0,0]},
{id:136,name:"Wind",mods:[0,4,0,0,0]},
